...
<body>
	...
	max-width: 560px;' class='container'>
			...
			font-family: sans-serif;' class='header'>
                                <a target='_blank' style='text-decoration: none;' href='https://github.com/konsav/email-templates/'><img border='0' vspace='0' hspace='0' src='https://raw.githubusercontent.com/viveksoni100/images.blogs/master/other/GU_Logo.JPG' width='100' height='30' alt='Logo' title='Logo' style='
				color: #000000;
			...
			color: #000000;
			font-family: sans-serif;' class='paragraph'>
                                Have a&nbsp;question? <a href='mailto:janu28project@gmail.com' target='_blank' style='color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;'>janu28project@gmail.com</a>
                            </td>
                        </tr>
                    </table>
                    <table border='0' cellpadding='0' cellspacing='0' align='center' width='560' style='border-collapse: collapse; border-spacing: 0; padding: 0; width: inherit;
